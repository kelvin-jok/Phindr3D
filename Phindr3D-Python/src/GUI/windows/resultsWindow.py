...
from .interactive_click import interactive_points, shift_press, shift_release
import pandas as pd
...
class resultsWindow(QDialog):
    def __init__(self, color):
        ...
        #when hold shift prevent zoom/pan
        #shift_hold=shift_press(self.main_plot, interactive_points(self.main_plot, self.projection, self.plot_data, self.labels, self.feature_file, color, self.imageIDs), self.shift_cid)
        #self.main_plot.fig.canvas.mpl_connect('key_press_event', shift_hold)
        #shift_released=shift_release(self.main_plot, self.projection, self.shift_cid)
        # matplotlib callback mouse/scroller actions
        #self.main_plot.fig.canvas.mpl_connect('key_release_event', shift_released)
